...
start_node = st.sidebar.selectbox("選擇起始節點", ["A", "B", "C", "D", "E", "F"], index=0)
target_node = st.sidebar.selectbox("選擇目標節點", ["A", "B", "C", "D", "E", "F"], index=5)
speed = st.sidebar.slider("動畫速度", 0.5, 3.0, 1.0, 0.1)
run_dijkstra = st.sidebar.button("執行 Dijkstra 演算法")
